          ...
          <div className="flex flex-col md:flex-row items-center gap-3">
            ...
            <div className="text-center md:text-left">
              ...
              <p className="text-xl text-blue-400 mb-4">
                Front End Tech Lead - React, React Native, Redux, Node, Express,
          ...
          <div className="space-y-8">
            ...
            <Card className="bg-gray-900 border-gray-800">
              <CardContent className="p-6">
                ...
                <ul className="text-gray-400 list-disc pl-4 space-y-2">
                  <li>
                    Online Food Ordering Application base architecture in React
                    and Node
                  </li>
                  <li>
                    Design and development of api using Spatial data types in
                    MYSQL
                  </li>
            ...
            <div>
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {["Xml", "Json", "Git", "Jira", "Postman", "Clickup"].map(
                      (tool) => (
                        <Badge
                          key={tool}
                          variant="secondary"
                  ...
                  <div className="flex justify-between items-start mb-4">
                    <div>
                      ...
                      <p className="text-blue-400">
                        Vikram College of Engineering, Madurai
                      </p>
                    </div>
